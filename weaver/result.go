...
// String returns a formatted summary of the crawl results, including
...
func (w *Web) writeTree(sb *strings.Builder) {
...
// ErrorLog returns a formatted error report of all failed URLs,
// grouped by error reason. Returns empty string if no errors occurred.
func (w *Web) ErrorLog() string {
